    ...
    <div className="page-wrapper">
      ...
      <nav data-animation="over-left" className="navbar w-nav" data-easing2="ease-in-out" data-easing="ease-in-out"
        ...
        <div className="nav-container">
          ...
          <div role="navigation" className="nav-menu-block w-nav-menu">
      ...
      <div className="main-wrapper">
        ...
        <section className="about-hero">
          <div className="padding-24px">
            <div style={{
              ...
              <h1 className="heading-3">
                We push boundaries, and infuse our projects with our infectious enthusiasm
              </h1>
              <div className="about-hero-description-block">
                <p className="body-text-large">
                  At Trahom — We&apos;re dedicated to supporting children in Gaza
                  through direct aid, safe housing, and emotional care, creating hope for brighter
                  futures.
                </p>
              </div>
            </div>
          ...
          <div className="about-hero-video-block">
            <div 
              data-poster-url="https://cdn.prod.website-files.com/676da05f8db3cad1ce7f9295%2F677541eb013b809b4386d706_WhatsApp%20Video%202024-12-30%20at%20175529%20%281%29-poster-00001.jpg"
              ...
              data-loop="true" 
              data-wf-ignore="true"
              data-w-id="89de3f97-0d38-4731-d937-f585ef177221" 
              style={{ opacity: 0 }}
              className="about-hero-video w-background-video w-background-video-atom"
            >
              <video
                id="89de3f97-0d38-4731-d937-f585ef177221-video" 
                autoPlay 
                loop
                style={{
                  backgroundImage: 'url("https://cdn.prod.website-files.com/676da05f8db3cad1ce7f9295%2F677541eb013b809b4386d706_WhatsApp%20Video%202024-12-30%20at%20175529%20%281%29-poster-00001.jpg")'
                }}
                muted 
                playsInline 
                data-wf-ignore="true" 
                  ...
                  <div className="about-text-content-wrapper">
                    ...
                    <div className="about-description-block">
                      <p className="body-text-regular">
                        We are part of the communities we serve. With boots
                        on the ground in Gaza, we bring empathy, resilience, and dedication to every
                        mission. It&apos;s not just about meeting immediate needs; it&apos;s about building
                        lasting change. Through collaboration with local communities and unwavering
                        commitment, we craft solutions that empower, uplift, and create a foundation
              ...
              <div className="about-text-block">
                <div className="padding-24px">
                  <div className="about-text-content-wrapper">
                    ...
                    <div className="about-description-block">
                      <p className="body-text-regular">
                        What began as one man&apos;s mission to support orphans
                        of war in Gaza has grown into a movement of hope and resilience. Starting
                        with small acts of financial aid, the campaign now touches the lives of over
                        1,500 orphans through direct monthly sponsorships. Along the way, TRAHOM has
                        launched transformative campaigns to provide food, clean water, firewood,
                        and other essentials, ensuring that no child is left behind. This is more
                        than aid—it&apos;s a testament to the power of compassion and the impact of a
                        single spark igniting a brighter future
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="footer">
          <div className="footer-cta-block">
            <div className="padding-24px cta-mobile-padding">
              <Link 
                data-w-id="89eb3467-b88c-0c65-5f8c-b0aa2090ab73"
                href="/contact" 
          ...
          <div className="footer-links-wrapper">
            ...
            <div id="w-node-_89eb3467-b88c-0c65-5f8c-b0aa2090ab95-2090ab70"
              className="footer-links-single-block-v3">
              <div className="footer-links-wrapper-inner">
